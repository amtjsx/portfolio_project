...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Deep dive into React Hooks and learn how to build more efficient and maintainable React applications.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Learn the fundamental UX principles that every developer should know to create better user experiences.",
    content: `
  ...
  },
  {
    ...
    excerpt: "A detailed comparison of the three major frontend frameworks to help you make an informed decision.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Tips and techniques to make your portfolio website lightning fast and improve user engagement.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Modern techniques and patterns for creating truly responsive web applications that work on any device.",
    content: `
